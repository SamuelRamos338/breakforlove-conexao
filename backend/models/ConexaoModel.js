...
const conexaoSchema = new mongoose.Schema({
  usuario1: { type: mongoose.Schema.Types.ObjectId, ref: 'Usuario', required: true }, // Solicitante
  nome1: { type: String, required: true }, //nome pessoa
  usuario2: { type: mongoose.Schema.Types.ObjectId, ref: 'Usuario', required: true }, // Solicitado
